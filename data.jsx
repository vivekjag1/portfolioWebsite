...
export const PROJECTS = [
  { name: "Compiler-informed decompilation",  year: "2026-Present", desc: "Researching the development of a decompiler which uses knowledge of the original compiler to recover source code effectively from compiled binaries.", stack: ["ANGR", "Rust", "Decompilation", "Reverse Engineering"]},
