...
export const FrameworkComponent = (props:FrameworkProps) => {
  return(
    ...
    <div className="flex flex-col items-center justify-center shadow-xl  rounded-2xl h-[12rem] w-[12rem] bg-gray-200 lg:mr-3 mb-3">
      <div className="flex flex-col  items-center justify-center  rounded-2xl h-[11.75rem] w-[11.75rem] bg-gray-200">
